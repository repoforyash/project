...
public class LoanAppDetailMasterController {
	...
	public ResponseEntity<List<ReducedPaymentDTO>> calculateReducedPaymentList(@PathVariable("loanAppId") String loanAppId) {
		
		log.info("Returns a list of pending EMIs");
